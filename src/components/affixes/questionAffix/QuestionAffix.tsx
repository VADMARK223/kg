...
const QuestionAffix = (): JSX.Element => {
  return (
    <>
      ...
      В вопросительных предложениях к словам, которые выражают предмет интереса присоединяется вопросительных
      аффикс <b>-бы?</b> (См. таблицу ниже)
      <br/>
      Такие вопросительные предложения называются <b>общими.</b> Они требуют ответа <b>&quot;ооба&rdquo;</b> (да)
      или <b>&quot;жок&rdquo;</b> (нет).
      <br/>
      Отрицательный ответ на вопрос содержит отрицание <b>&quot;эмес&rdquo;</b> (не). В предложении оно находится после
      слова, которое отрицается.
