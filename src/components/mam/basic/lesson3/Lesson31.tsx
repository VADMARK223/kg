...
const Lesson31 = (): JSX.Element => {
  return (
    <>
      ...
      <p>
        Это значение реализуется при помощи <b>аффиксов принадлежности.</b> (см. <Link to={RoutePath.BELONGING_SINGLE}>Образование категории принадлежности единственного числа</Link>)
      </p>
      <p>
